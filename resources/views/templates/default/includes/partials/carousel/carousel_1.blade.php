    ...
    <div class="slider-content text-left">
        <div class="container h-100">
            <div class="row align-items-center h-100">
                <div class="col-md-12">
                    <h2 class="slide-title-box" data-animation-in="slideInDown">{{ $modelTopSlide->field('d996ff725193') }}</h2>
                    <h3 class="slide-title" data-animation-in="fadeIn">{{ $modelTopSlide->field('ef839cc8da6c') }}</h3>
                    <h3 class="slide-sub-title" data-animation-in="slideInLeft">{{ $modelTopSlide->field('b1c99b14ba80') }}</h3>
